...
void TRKServices::createVacuumCompositeShape()
{
  ...
  Double_t vacuumASideLength = A3IPLength / 2. - vacuumVesselThickness - vacuumVesselLength;
  Double_t vacuumCSideLength = A3IPLength / 2. + vacuumVesselLength;
  ...
  // Vacuum positions
  TGeoTranslation* posVacuumASide = new TGeoTranslation("VACUUM_ASIDE_POSITION", 0, 0, vacuumVesselLength + vacuumVesselThickness + vacuumASideLength / 2.);
  posVacuumASide->RegisterYourself();
  TGeoTranslation* posVacuumCSide = new TGeoTranslation("VACUUM_CSIDE_POSITION", 0, 0, vacuumVesselLength - vacuumCSideLength / 2.);
